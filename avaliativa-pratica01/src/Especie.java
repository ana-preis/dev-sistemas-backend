...
public class Especie {
    ...
    public Especie(String nome_cientifico, String nome_comum, Habitat habitat, String distribuicao_geografica, String caracteristicas_morfologicas) {
    ...
    public boolean equals(Object o) {
        ...
        return getNome_cientifico().equals(especie.getNome_cientifico()) && getNome_comum().equals(especie.getNome_comum()) && getHabitat() == especie.getHabitat() && getDistribuicao_geografica().equals(especie.getDistribuicao_geografica()) && getCaracteristicas_morfologicas().equals(especie.getCaracteristicas_morfologicas());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getNome_cientifico(), getNome_comum(), getHabitat(), getDistribuicao_geografica(), getCaracteristicas_morfologicas());
    }
